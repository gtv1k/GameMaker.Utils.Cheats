 ...
 * Clear the console
 */
variable_global_set("cheat_clear", function(args) 
{
 ...
 */
variable_global_set("cheat_shell_set_width", function(args) 
{
	if (array_length(args) > 1) 
	{
 ...
 */
variable_global_set("cheat_shell_set_height", function(args) 
{
	if (array_length(args) > 1) 
	{
		if (string_digits(args[1]) != "") 
 ...
 */
variable_global_set("cheat_shell_set_anchor_v", function(args) 
{
	if (array_length(args) > 1) 
	{
 ...
 */
variable_global_set("cheat_shell_set_anchor_h", function(args) 
{
	if (array_length(args) > 1) {
		var newAnchor = args[1];
